        ...
        <table class="w3-table-all">
            ...
            <?php
             while($row = mysqli_fetch_array($res)){
                 ...
                 echo "<td>".$row['opis']."</td>";
                 echo "<td><img src='".$row['slika']."'  width='100px' ></td>";
            ...
            <tr>
                ...
                <td>
                    <img src="../slike/all_colors__eppfcocn9mky_large.jpg" 
            ...
            <tr>
                ...
                <td>
                    <img src="../slike/galaxy-z-flip5-highlights-colors-mint (1).webp" 
            ...
            <tr>
                ...
                <td>
                    <img src="../slike/redmi_note_12s_ice_blue_1_.webp" 
                    width="100px" alt="Galaxy S23 Ultra"></td>
                <td>611.45</td>
            </tr>
            ...
            <tr>
                ...
                <td><img src="../slike/S23Plus_Lavender_MO.avif" width="100px" alt="Xiaomi 13T Pro Alpine Blue"></td>
                <td>611.45</td>
            </tr>
            <tr>
                <td>5.</td>
                ...
                <td><img src="../slike/xiaomi_12_pro_gray_12-256gb_4_.webp" width="100px" alt=""></td>
                <td>287.63</td>              
            </tr>
            <tr>
                <td>6.</td>
                ...
                <td>
                    <img 
                        src="../slike/Xiaomi13T_Blue_Fryer_231004133913_500x700.png" 
                        width="100px" 
                        alt=""></td>
                <td>180</td>
            </tr>
